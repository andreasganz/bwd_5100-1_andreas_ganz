...
<?php require_once('../../cms/05_file-edit/edit-proccess_user.php') ?>

<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="utf-8">
    <title>Das Update-Form</title>
...
<!-- Headline -->
        <h1>Das Update-Form</h1>
        <h2>fürs Fan-Forum</h2>

<!-- Back-to-Edit-Button -->
        <a href="../edit.php"><img src="../../pictures/cms/back-button_round_grey.svg" alt="Back-to-Edit-Button fürs CMS" class="dashboard_overview"><span class="button_description back">Edit-Bereich</span></a>

<!-- Update-Formular -->
        <form class="login-form" method="post" action="eintrag_bearbeiten_user.php" enctype="multipart/form-data">
